...
- (id)initWithURL:(NSURL*)url completionBlock:(void(^)(void))a_completionBlock {
    ...
    if (self = [super initWithRootViewController:self.webViewController]) {
        ...
        self.webViewController.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Done", @"IFALocalizable", nil) style:UIBarButtonItemStylePlain target:webViewController action:@selector(doneButtonClicked:)];
    }
    return self;
}
