...
void _startDocument(void *context)
{
	IFA_DTHTMLParser *myself = (__bridge IFA_DTHTMLParser *)context;
...
void _dterror(void *context, const char *msg, ...)
{
	...
	myself.parserError = [NSError errorWithDomain:@"IFA_DTHTMLParser" code:1 userInfo:userInfo];
...
@implementation IFA_DTHTMLParser
{
	...
	DT_WEAK_VARIABLE id <IFA_DTHTMLParserDelegate> _delegate;
